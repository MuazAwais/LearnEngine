...
const InstructorsCard = () => {
  ...
  return (
    <div className="container">
        ...
        {card.map((instructor, index) => (
          ...
          >
            ...
            <div className="flex justify-between items-center w-full px-2">
              ...
              <button className="bg-[#319D8E] px-[25px] py-[13px] rounded-xl text-white flex items-center hover:bg-white hover:text-[#319D8E] border border-[#319D8E] hover:cursor-pointer transition-all duration-300 ease-in-out text-[12px]">
                Join Now
              </button>
            </div>
      ...
      <div className="mt-4">
        <button className="bg-[#FE7558] mx-auto px-[25px] py-[13px] rounded-xl text-white text-[12px] flex items-center justify-center hover:bg-white hover:text-[#FE7558] border border-[#FE7558] hover:cursor-pointer transition-all duration-300 ease-in-out">
          See more...
        </button>
      </div>
    </div>
